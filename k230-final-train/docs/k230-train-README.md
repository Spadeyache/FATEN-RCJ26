...
This folder is a fresh workspace. It **references** but does not modify
`..\k230-training\` and `..\k230-inference\`.
...
- **Linux Docker `k230d-convert`** -- runs the nncase compile pipeline
  and the PC simulator evaluations. nncase 2.9.0 + nncase-kpu 2.9.0 +
  .NET 7.0. Defined at `..\k230-training\docker\convert\Dockerfile`.
