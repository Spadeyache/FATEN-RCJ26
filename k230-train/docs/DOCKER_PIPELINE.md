...
`k230d-convert` (defined in `../k230-training/docker/convert/Dockerfile`).
It bundles:
...
```powershell
# From repo root
cd C:\Users\magic\Documents\robocup\RoboCupJunior_RescueLine
...
```powershell
docker run --rm -it `
    -v C:\Users\magic\Documents\robocup\RoboCupJunior_RescueLine\k230-train:/k230-train `
    -v C:\Users\magic\Documents\robocup\RoboCupJunior_RescueLine\k230-training:/k230-training `
    -v C:\Users\magic\Documents\robocup\RoboCupJunior_RescueLine\k230-training\datasets:/datasets `
    -w /k230-train `
    k230d-convert:latest /bin/bash
```
...
from `../k230-training/datasets/my_dataset/train/images/` covering both
