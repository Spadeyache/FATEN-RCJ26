...
def main():
    ...
    parser.add_argument("--quant-type", type=str, default="uint8", choices=["uint8", "int8", "int16"])
    parser.add_argument("--w-quant-type", type=str, default="uint8", choices=["uint8", "int8", "int16"])
    parser.add_argument(
